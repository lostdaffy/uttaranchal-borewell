          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="text-center p-4 bg-[#3dc1d312] rounded-lg">
                  <i className="ri-shield-check-line text-[#3dc1d3] text-3xl mb-2"></i>
                  <h5 className="font-semibold text-gray-900">ISO Certified</h5>
                </div>
                <div className="text-center p-4 bg-[#3dc1d312] rounded-lg">
                  <i className="ri-award-line text-[#3dc1d3] text-3xl mb-2"></i>
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-[#3dc1d3] rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-[#3dc1d3] to-[#2aa5b8] p-6 rounded-lg text-white">
