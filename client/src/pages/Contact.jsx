      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            {/* Address */}
            <div className="text-center p-8 bg-[#3dc1d312] rounded-lg">
              <div className="w-16 h-16 bg-[#3dc1d3] rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <div className="w-full h-[400px] rounded-lg overflow-hidden shadow-xl border border-gray-200 mt-12">
            <iframe
